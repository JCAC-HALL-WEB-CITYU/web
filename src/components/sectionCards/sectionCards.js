										...
										<div className="row">
											<div className="col-4 col-6-medium col-12-small">
												<section className="box">
													<a href="#"  id="cardsImage" className="image featured"><img  src="/web/homepage/MAC.png" alt="" /></a>
													<header>
														<h3>M.A.C. NIGHT</h3>
													</header>
											...
											<div className="col-4 col-6-medium col-12-small">
												<section className="box">
													<a href="#"  id="cardsImage" className="image featured"><img src="/web/homepage/SOCCER.png" alt="" /></a>
													<header>
														<h3>PEK SOCCER</h3>
													</header>
											...
											<div className="col-4 col-6-medium col-12-small">
												<section className="box">
													<a href="#"  id="cardsImage" className="image featured"><img src="/web/homepage/ATHLETIC.png" alt="" /></a>
													<header>
														<h3>PEK ATHLETIC</h3>
													</header>
