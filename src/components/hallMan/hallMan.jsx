								...
								<div className="row" id="RTimg">
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center flex-row-reverse pr-1 ">
										...
										<div className="RTinfo">
											...
											<div className="info">Hall Book, PEK Soccer Competition, Cooking Competition, MAC Night (Sem A)</div>
										</div>
									</div>
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center pr-1 goDown">
										...
										<div className="RTinfo RTinfoR">
											...
											<div className="info infoR">Advocacy | Liason, PEK Athletic Relay, Welcoming Reception (Sem B)</div>
										</div>
									</div>
									</div>
									<div className="row" id="RTimg">
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center flex-row-reverse pr-1 ">
										...
										<div className="RTinfo">
											...
											<div className="info">Senior RT, Hall Discipline, PEK Photography, Integration Trip</div>
										</div>
									</div>
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center pr-1 goDown">
										...
										<div className="RTinfo RTinfoR">
											...
											<div className="info infoR">Finance, PEK  Tug-of-War, Mid-autumn Festival, Q&A Competition</div>
										</div>
									</div>
									</div>
									<div className="row" id="RTimg">
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center flex-row-reverse pr-1 ">
										...
										<div className="RTinfo">
											<div className="w-100"><div className="triangle"></div><div className="title"><span>701B</span> / Vict	or</div></div>
											<div className="info">PEK Hall Coordinator, PEK Basketball Competition, Welcoming Reception (Sem A), SRO Liason</div>
										</div>
									</div>
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center pr-1 goDown">
										...
										<div className="RTinfo RTinfoR">
											...
											<div className="info infoR">Secretary, PEK Sing Con, Floor Decoration</div>
										</div>
									</div>
									</div>
									<div className="row" id="RTimg">
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center flex-row-reverse pr-1 ">
										...
										<div className="RTinfo">
											...
											<div className="info">Returning, Scholarship, PEK Table tennis, Academians' Talk, MAC Night (Sem B)</div>
										</div>
									</div>
									<div className="col-md-6 col-12 p-0 m-0 my-auto d-flex justify-content-md-start justify-content-center pr-1 goDown">
										...
										<div className="RTinfo RTinfoR">
											...
											<div className="info infoR">Facilities, Spring Festival, PEK Rowing, Food Journey, Q&A Competition</div>
										</div>
									</div>
									</div>
							</div>
