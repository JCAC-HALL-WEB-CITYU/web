				...
				<div className="container ">
						...
						<div class="col-12 p-0 p-sm-3">
							...
							<section>
								<div class="row">
									...
									<div class="p-0 pb-3 p-sm-3 col-sm-6 col-12 flexDown">
										<a href="#" class="image featuring"><img src="./web/homepage/tutor_photo/Eugene.JPG" alt="" /></a>
										<section class="box no-box">
											<header>
												<h3>Eugene LOW</h3>
												<p>1 - 2 / F</p>
					...
					<div className="row margin-top">
						<div class="col-12">
							...
							<section class="container">
								<div class="row"> */}
									<div class="p-0 pb-3 p-sm-3 col-sm-6 col-12 flexDown">
										<a href="#" class="image featuring"><img src="./web/homepage/tutor_photo/Alex.JPG" alt="" /></a>
										<section class="box no-box">
											<header>
												<h3>Alex XIAO</h3>
												<p>3 / F</p>
					...
					<div className="row margin-top">
						<div class="col-12">
							...
							<section>
								<div class="row"> */}
									<div class="p-0 pb-3 p-sm-3 col-sm-6 col-12 flexDown">
										<a href="#" class="image featuring"><img src="./web/homepage/tutor_photo/Naeem.JPG" alt="" /></a>
										<section className="box no-box">
											<header>
												<h3>NAEEM Muhammad</h3>
												<p>4 / F</p>
											</header>
											{/* <footer>
												<ul class="actions">
									...
									<div class="p-0 pb-3 p-sm-3 col-sm-6 col-12 flexDown">
										<a href="#" class="image featuring "><img src="./web/homepage/tutor_photo/Andrew.JPG" alt="" /></a>
										<section class="box no-box">
											<header>
												<h3>Andrew LI</h3>
												<p>5 / F</p>
						...
						<div class="col-12">
							...
							<section>
								<div class="row"> */}
									...
									<div class="p-0 pb-3 p-sm-3 col-sm-6 col-12 flexDown">
										<a href="#" class="image featuring "><img src="./web/homepage/tutor_photo/Chriss.JPG" alt="" /></a>
										<section class="box no-box">
											<header>
												<h3>Chriss CHIN</h3>
												<p>8 - 9 / F</p>
					...
					<div className="row margin-top">
						<div class="col-12">
                            ...
                            <div class="p-0 pb-3 p-sm-3 col-sm-6 col-12 flexDown">
                                <a href="#" class="image featuring"><img src="./web/homepage/tutor_photo/SzeSze.JPEG" alt="" /></a>
                                <section class="box no-box">
                                    <header>
                                        <h3>SzeSze LAM</h3>
                                        <p>11 / F </p>
					...
					<div className="row">
						<div className="col-lg-4 col-12">
							...
							<div className="parentP">
								<p>
									Welcome to our JCAC (Jockey Club Academy Hall) big family of Academians! Here you will meet our fellow students with diverse background from different disciplines and countries. This is a good place for you to enlarge your social circle and make more friends. Enjoy yourlife here!
												</p></div>
						</div>
