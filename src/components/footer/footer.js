									...
									<div className="col-12 col-md-4">
										<section>
											...
											<ul className="social">
												...
												<li><a className="icon fa-instagram" target="_blank" href="https://www.instagram.com/hall4_fortress_jcac/?hl=en"><span className="label">Instagram</span></a></li>
												<li><a className="icon fa-youtube" target="_blank" href="https://www.youtube.com/user/cityujcac?app=desktop"><span className="label">Youtube</span></a></li>
