				...
				<div className="homepage">
					<div id="page-wrapper">
						...
						<section id="header">
							...
							<Header></Header>
							<Cover coverText={"Facilities @ JCAC"} imgSrc={"./web/aboutJCAC/about.png"} dontRenderButton={false}></Cover>
						</section>
								...
								{/* <article class="box post">
									...
									<section>
										...
										<p className="text-justify">
											Opened on March 15, 2004, Jockey Club Academy Hall (JCAC) has quickly ascended to be one of the most dynamic halls in City University of Hong Kong. It embraces the whole-person education ideal of the University, offering students a balanced life and an extension of learning beyond the classroom.</p>
										<p className="text-justify">
